export const data = [
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904796/Upzyde/increased-revenue_fvz54h.webp",
    title: "Guaranteed revenue increase",
    description:
  ...
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904797/Upzyde/commitments_xc9cik.webp",
  ...
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904798/Upzyde/payments_mktoer.webp",
  ...
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904800/Upzyde/expertise_nmut0n.webp",
    title: "In-dept expertise",
    description:
  ...
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904801/Upzyde/ad-quality_tshdz9.webp",
    title: "Ensured Ad Quality",
    description:
      "Publishers will only receive demand from tier one SSPs and agencies.",
  },
  {
    imageUrl:
      "https://res.cloudinary.com/dqove2qhg/image/upload/v1653904925/Upzyde/open-platform_pump4m.webp",
